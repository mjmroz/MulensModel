...
from MulensModel.triplelens import TripleLensMagnification
from .version import __version__

__all__ = ['TripleLensMagnification', 'MultipleLensVBMMagnification', 'MultipleLensPointSourceVBMMagnification',
