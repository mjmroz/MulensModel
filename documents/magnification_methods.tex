...
model.set_magnification_methods(
    [2455745., 'Hexadecapole', 2455746., 'VBM', 2455747., 'Hexadecapole', 2455748.])
\end{verbatim}
...
{\tt VBM} and {\tt Adaptive\_Contouring} allow providing these parameters. 
...
\item {\tt VBM} -- Bozza (2010) method -- finite source with limb darkening.  Most widely used method nowadays.  Parameters that ca be set: {\tt accuracy}.  This method replaces \texttt{VBBL} but both names are accepted.
...
\item {\tt Twinkle} -- GPU-based method for calculating magnification of finite source with limb darkening.  It is based on Wang et al. (2025)  method.  Parameters that can be set: {\tt device\_num}, {\tt N\_stream}, and {\tt RelTol}.
